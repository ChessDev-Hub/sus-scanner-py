...
class UserMetrics:
    ...
    timeout_win_ratio: float = 0.0   # context only (wins by opp resign/timeout)
...
class SusScanner:
    ...
    def analyze_user(self, username: str) -> UserMetrics:
        ...
        # NOTE: no bump for timeout_win_ratio (context only)
    ...
    def print_table(self, metrics: List[UserMetrics]) -> None:
        ...
        for m in metrics:
            ...
            print(
                ...
                f"{m.nt_self_bail_loss_ratio:>10.0%} {m.t_self_bail_loss_ratio:>9.0%} "
    ...
    def write_csv(self, path: str, metrics: List[UserMetrics]) -> None:
        ...
        with open(path, "w", newline="", encoding="utf-8-sig") as f:
            ...
            w.writerow([
                ...
                "nt_self_bail_loss_ratio","t_self_bail_loss_ratio",
            ...
            for m in metrics:
                ...
                w.writerow([
                    ...
                    f"{m.nt_self_bail_loss_ratio:.6f}", f"{m.t_self_bail_loss_ratio:.6f}",
                    f"{m.suspicion_score:.2f}", reasons_txt
                ])
        ...
        for url in archives:
            ...
            for g in data["games"]:
                ...
                out.append(GameSummary(
                    ...
                    plies=plies, end_reason=end_reason,
                    is_rated=rated, from_tournament=from_tourn, end_time=end_time
                ))
...
if __name__ == "__main__":
    # Example: use club members by default if usernames.txt not provided
